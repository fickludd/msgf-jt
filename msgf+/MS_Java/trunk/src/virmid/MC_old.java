...
public class MC_old {
    ...
    public static void printMatrix(double[][] m) {
        for (int i = 0; i < m.length; i++) {
            for (int j = 0; j < m[i].length; j++) {
                System.out.print(String.format("%.8e", m[i][j]) + " ");
            }
            System.out.println();
        }
    }
    ...
    public static void printVector(double[] m) {
        for (int i = 0; i < m.length; i++) {
            System.out.print(String.format("%.8e", m[i]) + " ");
        }
        System.out.println();
    }

    public static void normalize(double[][] m, double sum) {
        double s = 0;
        for (int i = 0; i < m.length; i++) {
            for (int j = 0; j < m[i].length; j++) {
                s = s > Math.abs(m[i][j]) ? s : Math.abs(m[i][j]);
            }
        }
