...
public class MutMatchObject extends MatchObject {
  ...
  public static String getSummaryHeader() {
     ...
     * 13. Mutation position (relative)
     * 14. Original Amino Acid
     * 15. Mutated Amino Acid
     * 16. Detailed Identification
     */
  ...
  public String getSummaryLine(String filename, 
    ...
    if(getMutationSource() == getMutationSink()){
    	 sb.append("\t\t\t");
    }else{
    // 13. Mutation position
