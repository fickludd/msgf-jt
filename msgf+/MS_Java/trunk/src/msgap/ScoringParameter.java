...
public class ScoringParameter {
	...
	public ScoringParameter(int specID, Spectrum s, String specfilename, GappedGeneratingFunction<NominalMass> gap, float originalParentMass, ScoredSpectrum<NominalMass> scoredSpec){
		this.specID = specID;
