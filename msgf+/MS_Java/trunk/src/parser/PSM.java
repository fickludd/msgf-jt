...
public class PSM {
	...
	public static class PSMSpecNumComparator implements Comparator<PSM> {
		public int compare(PSM o1, PSM o2) {
	...
	public static class PSMScanNumComparator implements Comparator<PSM> {
		public int compare(PSM o1, PSM o2) {
			if(o1.scanNum > o2.scanNum)
				return 1;
			else if(o1.scanNum == o2.scanNum)
	...
	public static class PSMProbScoreComparator implements Comparator<PSM> {
		public int compare(PSM o1, PSM o2) {
