...
public class MSGFPlus {
	public static final String VERSION = "JT branch (v9949-2)";
	public static final String RELEASE_DATE = "18/09/2015";
    ...
    private static String runMSGFPlus(int ioIndex, SpecFileFormat specFormat, File outputFile, SearchParams params)
    {
		...
		SpectraAccessor specAcc = new SpectraAccessor(specFile, specFormat, params.getIntensityThreshold());
